...
// max training records the train records buffer can hold (NRCCache.cpp
// allocates NRC_TRAIN_BATCH_COUNT * NRC_TRAIN_BATCH_SIZE * 40 bytes);
// runtime batch size from NRCFrameParams.uTrainBatchSize is clamped to this
